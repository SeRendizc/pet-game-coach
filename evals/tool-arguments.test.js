...
import {createGame,legalActions,resolveTurn,chooseEnemy,active,SKILLS,damage} from '../engine.js';
...
import {runCoach,buildContext,gatherAgentEvidence,defaultArgsFor,resolveEvidenceTurn,policyFor,checkReceiptConsistency} from '../coach/runtime.js';
import {executeTool,actionId,parseActionId,resolveMentionedActions,illegalReason,evidenceMatchId} from '../coach/toolbox.js';
