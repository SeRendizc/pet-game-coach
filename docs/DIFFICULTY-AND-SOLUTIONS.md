...
>
> 代码基线：UI v0.10 / 游戏规则 v0.6，12 只宠物，可运行本机 Demo（`npm start`，http://127.0.0.1:8765/ ）。
> 自动测试：**122 项全部通过**（作者在本机实跑 `npm test`：`tests 122 / pass 122 / fail 0`）。
>
...
| 「小田」（和平精英）的任何功能细节 | **完全未调研** | 仓库内检索「小田」零命中；另见 `docs/COMPANION-DESIGN.md` |
