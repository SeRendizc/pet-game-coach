...
import {searchKnowledge, buildKnowledgePacket} from './coach/retrieval.js';
...
test('generated reference facts stay tied to the engine rather than copied external game rules',async()=>{
 const {REFERENCE_CARDS}=await import('./content.js');const {SKILLS,SPECIES,createGame}=await import('./engine.js');
