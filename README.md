...
面向腾讯IEG面试题的本地宠物对战与LLM Coach原型。支持训练（对电脑）与**本地对战**（真人分屏同屏，或电脑对手）。当前UI v0.11、规则v0.6，12只宠物、5个关卡、3档电脑难度。小芽支持实时规则建议、可选DeepSeek有界工具调用、整局复盘、原位培养建议、条件提醒、变式练习、带证据的提醒习惯。**浏览器语音已暂停使用**（原因见下）。
