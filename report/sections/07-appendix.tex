...
\textbf{陪练角色的情绪实现。} 设计文档里有完整方案（情绪状态、语气档位、触发条件、禁止句式），代码里没有。题目允许非主角色只做设计，我把时间投给了军师和老师。需要强调的是：如果问"陪练有没有情绪"，准确答案是设计上有、实现上没有。
...
外部来源与它们各自的使用边界记在 \path{knowledge/sources.json} 与
\path{docs/DOMAIN-RESEARCH.md}。官方文档、公开转载与我的推断分开标注。
