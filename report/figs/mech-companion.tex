% 陪练机制图（放进 2.2 陪练小节）。图上每一步的出处，全部在 coach/companion.js：
...
%                  战术越界，命中任意一条整句丢掉
%   左下气泡       COMPANION_BUBBLE 的 position:'bottom-left' 与 style.css 的 left/bottom，
%                  由 app.js 的 placeCompanionBubble() 摆位、气泡可点掉
\begin{figure}[htbp]\centering
\begin{tikzpicture}[font=\scriptsize]
\node[mbox] (a1) {\mbody{什么时候开口}{companion.js}{{\ttfamily companionEvents()} 事件表}};
\node[mbox,right=8pt of a1.north east,anchor=north west] (a2)
  {\mbody{跨局账本 + 局内读数}{companion.js}{{\ttfamily companionLedger()}}};
\node[mbox,right=8pt of a2.north east,anchor=north west] (a3)
  {\mbody{挑一条算不出来的事}{companion.js}{{\ttfamily readingsFor() · fitReading()}}};
\draw[marr] (a1)--(a2); \draw[marr] (a2)--(a3);
\node[mbox,text width=92pt,anchor=north west] (b1) at ([yshift=-26pt]a1.south west)
  {\mbody{接住那个词}{companion.js}{{\ttfamily chatThread()} 闲聊线程}};
\node[mbox,text width=92pt,right=6pt of b1.north east,anchor=north west] (b2)
  {\mbody{情绪落点}{companion.js}{{\ttfamily turnMoment()} 落在这一手}};
\node[mbox,text width=92pt,right=6pt of b2.north east,anchor=north west] (b3)
  {\mbody{六条硬线}{companion.js}{{\ttfamily checkCompanionRestraint()}}};
\node[mbox,text width=92pt,right=6pt of b3.north east,anchor=north west] (b4)
  {\mbody{左下气泡}{app.js}{{\ttfamily placeCompanionBubble()}}};
