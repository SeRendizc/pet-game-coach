...
\begin{tikzpicture}[
  ...
  prow/.style={draw=black!55,rounded corners=2.5pt,minimum width=196pt,minimum height=16pt},
  ...
  \prow{1}{0}    {pterm}{玩家提问 / 自动触发}{app.js}
  \prow{2}{-0.8} {prow} {硬策略门控}          {policy.js}
  \prow{3}{-1.6} {prow} {有界工具循环}        {runtime.js}
  \prow{4}{-2.4} {prow} {引擎 / RAG 回执}     {toolbox.js}
  \prow{5}{-3.2} {prow} {一致性校验}          {runtime.js}
  \prow{6}{-4.0} {prow} {有界输出 / 沉默}     {runtime.js}
  \prow{7}{-4.8} {pterm}{事件记忆与反思}      {memory.js}
